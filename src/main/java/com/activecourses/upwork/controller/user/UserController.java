...
public class UserController {
    ...
    @Operation(summary = "Get My Profile",
            description = "Retrieve the profile of the currently authenticated user based on JWT token.")
    ...
    @Operation(summary = "Update My Profile",
            description = "Update the profile of the currently authenticated user based on JWT token.")
