...
public interface AuthService {
    ...
    CurrentUserDto getCurrentUserWithRoles();

    ResponseEntity<?> loginWithAudit(LoginRequestDto loginRequestDto, HttpServletRequest request);

    ResponseEntity<?> registerWithAudit(RegistrationRequestDto registrationRequestDto, HttpServletRequest request);
}
